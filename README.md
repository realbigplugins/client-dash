...
### [2.0.2](https://github.com/realbigplugins/client-dash/releases/tag/v2.0.2)
* Fix plugin installation bug.

### [2.0.1](https://github.com/realbigplugins/client-dash/releases/tag/v2.0.1)
* Bug fix for CD Pro not updating to 1.1

### [2.0.0](https://github.com/realbigplugins/client-dash/releases/tag/v2.0.0)
...
### [1.6.19](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.19)
* Bug fix for an invalid admin notice.

### [1.6.18](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.18)
* Bug fix for not showing proper Plugin sub-menu items in the menu customizer.

### [1.6.16](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.16)
* Bug fix with menus and some plugins/themes conflicting

### [1.6.15](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.15)
* Bug fix with Tools page

### [1.6.14](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.14)
* Make everything translatable

### [1.6.13](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.13)
* Add settings sidebar.

### [1.6.12](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.12)
* Fix potential menu editing bug.

### [1.6.11](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.11)
* Fix potential admin theme PHP notice.
* Fix potential fatal error due to improper static method call.

### [1.6.10](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.10)
* Fix issue with non-public post type menu items not showing in menu editor even when "show_in_menu" is true.

### [1.6.9](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.9)
* Fixed potential fatal error.

### [1.6.8](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.8)
* Fixed potential fatal errors when using dashboard widgets.
* Fix CD core widgets not working

### [1.6.7](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.7)
* Very minor bug fixes.
* Testing in the WordPress 4.1 environment.

### [1.6.6](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.6)
...
### [1.6.5](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.5)
...
### [1.6.4](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.4)
...
### [1.6.3](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.3)
...
### [1.6.2](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.2)
* Small bug with widgets on initial install.

### [1.6.0](https://github.com/realbigplugins/client-dash/releases/tag/v1.6.0)
...
### [1.5.5](https://github.com/realbigplugins/client-dash/releases/tag/v1.5.5)
* Fixed PHP notice error.

### [1.5.4](https://github.com/realbigplugins/client-dash/releases/tag/v1.5.4)
* Minor improvement in backend Roles functionality (allows compatibility with new WooCommerce extension).

### [1.5.3](https://github.com/realbigplugins/client-dash/releases/tag/v1.5.3)
* Multiple content sections in the same tab were not working.

### [1.5.2](https://github.com/realbigplugins/client-dash/releases/tag/v1.5.2)
* Postboxes being half width was targeting all pages, when it should have only been targeting the dashboard.

### [1.5.1](https://github.com/realbigplugins/client-dash/releases/tag/v1.5.1)
* PHP backwards compatibility issue.
* Check if class does not exist for Dash Widgets.

### [1.5](https://github.com/realbigplugins/client-dash/releases/tag/v1.5)
...
### [1.4](https://github.com/realbigplugins/client-dash/releases/tag/v1.4)
...
### [1.3.2](https://github.com/realbigplugins/client-dash/releases/tag/v1.3.2)
* Fixed php error on settings page for widgets.

### [1.3.1](https://github.com/realbigplugins/client-dash/releases/tag/v1.3.1)
* Fixed save button issue on Icons page.
* Added install/activate/deactivate button on addons page.

### [1.3](https://github.com/realbigplugins/client-dash/releases/tag/v1.3)
...
### [1.2.2](https://github.com/realbigplugins/client-dash/releases/tag/v1.2.2)
...
### [1.2.1](https://github.com/realbigplugins/client-dash/releases/tag/v1.2.1)
* Fixed php warning.
...
### [1.2](https://github.com/realbigplugins/client-dash/releases/tag/v1.2)
...
### [1.1.2](https://github.com/realbigplugins/client-dash/releases/tag/v1.1.2)
* Patch to fix potential fatal error when running on older versions of PHP.

### [1.1.1](https://github.com/realbigplugins/client-dash/releases/tag/v1.1.1)
* Fixed fatal error problem.

### [1.1](https://github.com/realbigplugins/client-dash/releases/tag/v1.1)
...
### [1.0](https://github.com/realbigplugins/client-dash/releases/tag/v1.0)
* Initial release.
